...
// console.log(isPalindrome('122212'));
...
// 		if (hash[t[i]] === 0 || hash[t[i]] === undefined) {
// 			return false;
// 		} else {
// 			hash[t[i]]--;
// 		}
...
// 	for (let i = buckets.length - 1; i >= 0 && solution.length < k; i--) {
// 		if (buckets[i] && buckets[i].length > 0) {
// 			console.log(solution);
// 			solution = [...solution, ...buckets[i]];
// 		}
// 	}
// 	return solution;
// }
...
// console.log(topKFrequent([4, 4, 4, 5, 5, 5, 5, 5, 6], 2));
...
// 	for (let i = 0; i < s.length; i++) {
// 		if (!sym[s[i + 1]] || sym[s[i]] >= sym[s[i + 1]]) {
// 			result += sym[s[i]];
// 		}
// 		if (sym[s[i + 1]] && sym[s[i]] < sym[s[i + 1]]) {
// 			result -= sym[s[i]];
...
// 	return pointer;
// }
// console.log(removeDuplicates([1, 1, 1, 1, 2, 3, 4, 4, 5]));
...
// function removeElements(nums, n) {
// 	let pointer = 0;
// 	for (let i = 0; i < nums.length; i++) {
// 		if (nums[i] !== n) {
// 			nums[pointer] = nums[i];
...
// 	return pointer;
// }
// removeElements([3, 3, 3, 2, 2, 3, 4, 4], 3);
...
// 	return left;
// }
// console.log(searchInsert([1, 3, 5, 6, 7, 10, 12, 15, 20], 2));
...
// 	console.log(arr);
// }
// console.log(lenghtLastWord('   fly me   to   the moon  '));
...
// 	let hash = {};
// 	for (let i = 0; i < arr.length; i++) {
// 		if (hash[arr[i]]) hash[arr[i]] = false;
...
// 		if (options[middle] === number) return options[middle];
// 		else if (options[middle] < number) {
// 			left = middle + 1;
// 		} else {
// 			right = middle - 1;
// 		}
...
function maxProfit(prices) {
	...
	for (let i = 0; i < prices.length; i++) {
		...
		if (currentPrice - buyingPrice > profit) {
...
// console.log(decToOcto(127));

// function razlomak(a, b, c, d) {
// 	let brojnik = a * d;
// 	let nazivnik = c * b;
...
// 	const num = gcd(brojnik, nazivnik);
// 	const arr = [brojnik / num, nazivnik / num];
// 	return arr.join(',').replace(',', '/');
// }

// console.log(razlomak(2, 2, 6, 5));
...
// function roman(int) {
// 	const romanTens = ['', 'X', 'XX', 'XXX', 'XL', 'L', 'LX', 'LXX'];
// 	const romanUnits = ['', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX'];

// 	let tens = Math.floor(int / 10);
// 	let units = int % 10;
